...
export default async function RootLayout({
  ...
  const mainClassName = hideNav ? "flex-1 pl-0" : "flex-1 pl-0 md:pl-28";
      ...
      <body suppressHydrationWarning>
        <AppProviders locale={locale} messages={messages}>
          ...
          <div className="relative flex min-h-screen">
            {!hideNav && (
              <nav className="fixed left-4 top-4 z-20 hidden md:block" suppressHydrationWarning>
                <SideBar />
              </nav>
            )}
            <main id="conteudo" className={mainClassName}>
              <div className="p-3 pb-24 md:p-5 md:pb-5">
                <div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-[1280px] flex-col overflow-hidden rounded-3xl border border-zinc-200/80 bg-white/75 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-shadow duration-300 dark:border-zinc-800/70 dark:bg-zinc-950/35 dark:shadow-2xl dark:shadow-black/40">
                  {!hideNav && <SiteHeader />}
